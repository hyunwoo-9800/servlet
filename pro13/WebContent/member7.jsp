	...
	<body>
		...
		<table align="center" width="100%">
			...
			<tr align="center">
				...
				<td>
					<jsp:getProperty name="m" property="pwd"></jsp:getProperty>
				</td>
				<td>
					<jsp:getProperty name="m" property="name"></jsp:getProperty>
				</td>
				<td>
					<jsp:getProperty name="m" property="email"></jsp:getProperty>
				</td>
			</tr>
